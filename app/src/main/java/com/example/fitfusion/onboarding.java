...
public class onboarding extends AppCompatActivity {
    ...
    private EditText ageInput, weightInput, heightInput, goalInput, bodyTypeInput;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bodyTypeInput = findViewById(R.id.bodyType);
        ...
        continueButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (age.isEmpty() || weight.isEmpty() || height.isEmpty() || goal.isEmpty() || bodyType.isEmpty()) {
                    Toast.makeText(onboarding.this, "Please fill out all fields", Toast.LENGTH_SHORT).show();
                } else {
                    saveOnboardingDataToFirestore(age, weight, height, goal, bodyType);
                }
            }
        });
    }

    private void saveOnboardingDataToFirestore(String age, String weight, String height, String goal, String bodyType) {
        ...
        onboardingData.put("bodyType", bodyType);
